...
// Configurable quick links (DASHBOARD_LINKS) rendered as a panel under Sessions in the sidebar.
fn links_panel_html(config: &Config) -> String {
    ...
    format!(
        r##"<section class="panel links-panel"><div class="panel-header"><div><h2>Links</h2><p class="muted">Quick jumps</p></div></div><div class="links-grid">{}</div></section>"##,
        items
    )
}
